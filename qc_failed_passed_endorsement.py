...
class FloatLineEdit(QLineEdit):
    ...
    def value(self) -> float:
        # Ensure we read the clean value, stripping commas
        try:
            clean_text = self.text().replace(',', '')
...
class QCFailedPassedPage(QWidget):
    ...
    def _clear_form(self):
        ...
        # Ensure float fields reset with proper formatting
    ...
    def _clear_form_previews(self):
        ...
        # Ensure labels are reset with proper formatting
    ...
    def _validate_and_calculate_lots(self):
        try:
            # Use value() to get float stripped of commas
    ...
    def _save_record(self):
        ...
        primary_data = {
            ...
            "quantity_kg": self.quantity_edit.value(), # value() strips commas
            "weight_per_lot": self.weight_per_lot_edit.value(), # value() strips commas
    ...
    def _load_record_for_update(self):
        ...
        try:
            ...
            # APPLY COMMA FORMATTING when loading into line edit
