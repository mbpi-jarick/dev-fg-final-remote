...
# REVISED - Modernized UI with group boxes and improved table styling.
...
class ManageListDialog(QDialog):
    def __init__(self, parent, db_engine, table_name, column_name, title):
        ...
        add_btn = QPushButton("Add")  # Removed space
        remove_btn = QPushButton("Remove")  # Removed space
...
class AddItemDialog(QDialog):
    def __init__(self, parent=None, db_engine=None, data=None):
        ...
        self.check_inventory_btn = QPushButton("Check Stock")  # Removed leading space and icon
        ...
        manage_qty_prod_btn = QPushButton("Manage...")  # Removed leading space and icon
...
class OutgoingFormPage(QWidget):
    ...
    def _setup_deleted_tab(self, tab):
        ...
        # Removed icons for deleted tab buttons
    ...
    def _setup_view_tab(self, tab):
        ...
        # Removed icons for view tab buttons
        ...
        # Removed icons for pagination buttons
    ...
    def _setup_entry_tab(self, tab):
        ...
        # Removed icons for fetch and manage buttons
        ...
        # Removed icons for item buttons
        ...
        # Removed icons for save/clear/cancel buttons
    ...
    # --- Methods involving context menus (where icons were removed) ---
    ...
    # --- Other necessary methods (Logic Unchanged) ---
