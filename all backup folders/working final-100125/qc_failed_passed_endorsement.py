...
class QCFailedPassedPage(QWidget):
    ...
    def init_ui(self):
        ...
        # Removed icons and use simple text names.
    ...
    def _setup_view_tab(self, tab):
        ...
        # Removed icon setting for buttons
        ...
        # Removed icon setting for pagination buttons
    ...
    def _setup_deleted_tab(self, tab):
        ...
        # Removed icon setting for refresh button
    ...
    def _perform_lot_calculation(self, total_qty, weight_per_lot, lot_input, is_range, excess_handling_method):
        ...
        if excess_qty > 0:
            if is_range and excess_handling_method == 'ASSIGN_TO_LAST_IN_RANGE' and range_end_lot:
                ...
                # Attempt to increment the lot number for the new lot if pattern matches, otherwise append -EXCESS
                if match:
                    try:
