...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit,
                             ...
                             QMessageBox, QGroupBox) # Removed QStyle
...
class TransactionsFormPage(QWidget):
    ...
    def init_ui(self):
        ...
        self.refresh_button = QPushButton("Refresh") # Removed leading space
        # Icon removed: self.refresh_button.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_BrowserReload))
