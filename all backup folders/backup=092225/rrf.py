# rrf.py
# FINAL UPDATE - Integrated real-time inventory validation for Lot Numbers on RAW MATERIAL type.
...
class RRFPage(QWidget):
    # ... (The rest of your RRFPage class, from __init__ onwards, is unchanged and complete) ...
