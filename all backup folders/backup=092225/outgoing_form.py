...
class AddItemDialog(QDialog):
    def __init__(self, parent=None, db_engine=None, data=None):
        ...
        layout.addRow("Location/Warehouse:", self.warehouse_combo)  # <-- ADDED WAREHOUSE FIELD
        ...
        self._load_warehouses()  # <-- LOAD WAREHOUSE DATA
        ...
        if data:
            ...
            self.warehouse_combo.setCurrentText(data.get('warehouse', ''))  # <-- POPULATE WAREHOUSE
    ...
    def get_data(self):
        return {
            ...
            "warehouse": self.warehouse_combo.currentText()  # <-- RETURN WAREHOUSE
        }
...
class OutgoingFormPage(QWidget):
    ITEM_TABLE_HEADERS = [
        ...
        "Status", "Box#", "Rem. Qty", "Qty Prod.", "Warehouse"  # <-- ADDED WAREHOUSE HEADER
    ]
    ...
    # --- THE REST OF THE OutgoingFormPage CLASS IS UPDATED BELOW ---
    # It includes the transaction logic and all helper methods.
