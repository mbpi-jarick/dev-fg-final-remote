...
# V9.0 - UI ENHANCEMENT: Added icons to all buttons/tabs and styled the selected row color.
...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QTabWidget, QFormLayout, QLineEdit,
                             ...
                             QApplication, QMainWindow) # Added for test runner
from PyQt6.QtGui import QDoubleValidator, QIcon

# --- Database Imports ---
from sqlalchemy import create_engine, text # Added create_engine for test runner
...
class QCFailedEndorsementPage(QWidget):
    ...
    def init_ui(self):
        ...
        self.tab_widget.setTabIcon(self.tab_widget.indexOf(self.view_tab),
        ...
        self.tab_widget.setTabIcon(self.tab_widget.indexOf(self.entry_tab),
                                   style.standardIcon(QStyle.StandardPixmap.SP_FileIcon))
        self.tab_widget.setTabIcon(self.tab_widget.indexOf(self.deleted_tab),
    ...
    def _setup_deleted_tab(self, tab):
        ...
        self.restore_btn.setIcon(style.standardIcon(QStyle.StandardPixmap.SP_DialogResetButton))
        self.restore_btn.setObjectName("update_btn")
        self.restore_btn.setEnabled(False)

        self.refresh_deleted_btn = QPushButton("Refresh")
        self.refresh_deleted_btn.setIcon(style.standardIcon(QStyle.StandardPixmap.SP_BrowserReload))
    ...
    def _setup_entry_tab(self, tab):
        ...
        self.preview_btn.setIcon(style.standardIcon(QStyle.StandardPixmap.SP_FileLinkIcon))
    ...
    def _create_managed_combo(self, table_name, combo):
        ...
        manage_btn.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_FileDialogContentsView))
    ...
    def _show_records_table_context_menu(self, pos):
        ...
        view_action.setIcon(style.standardIcon(QStyle.StandardPixmap.SP_MessageBoxInformation))
    ...
    def _show_deleted_table_context_menu(self, pos):
        ...
        restore_action.setIcon(style.standardIcon(QStyle.StandardPixmap.SP_DialogResetButton))
...
if __name__ == "__main__":
    ...
    try:
        with mock_engine.connect() as conn, conn.begin():
            ...
            conn.execute(text("CREATE TABLE failed_transactions(id INTEGER PRIMARY KEY);")) # Minimal tables to prevent errors
