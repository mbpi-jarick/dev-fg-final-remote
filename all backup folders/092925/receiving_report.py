...
class AddItemDialog(QDialog):
    ...
    def __init__(self, parent=None, data=None, warehouses=None, engine=None):
        ...
        if fa:
            self.check_lot_btn.setIcon(fa.icon('fa5s.check-circle', color='#27ae60'))
        ...
        if fa:
            add_location_btn.setIcon(fa.icon('fa5s.cogs', color='#7f8c8d'))
...
class ReceivingReportPage(QWidget):
    ...
    def init_ui(self):
        ...
        if fa:
            self.tab_widget.addTab(view_tab, fa.icon('fa5s.list-alt', color='#2980b9'), "All Reports")
            self.tab_widget.addTab(self.entry_tab, fa.icon('fa5s.edit', color='#27ae60'), "Report Entry")
            self.tab_widget.addTab(self.view_details_tab, fa.icon('fa5s.eye', color='#8e44ad'), "View Details")
            self.tab_widget.addTab(deleted_tab, fa.icon('fa5s.trash-alt', color='#c0392b'), "Deleted")
        else:
    ...
    def _setup_view_tab(self, tab):
        ...
        if fa:
            self.refresh_btn.setIcon(fa.icon('fa5s.sync-alt', color='#3498db'))
    ...
    def _setup_entry_tab(self, tab):
        ...
        if fa:
            add_row_btn.setIcon(fa.icon('fa5s.plus', color='white'))
            edit_row_btn.setIcon(fa.icon('fa5s.pen', color='#34495e'))
            remove_row_btn.setIcon(fa.icon('fa5s.minus', color='white'))
