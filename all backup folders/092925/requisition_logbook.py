...
class RequisitionLogbookPage(QWidget):
    ...
    def init_ui(self):
        ...
        # --- MODIFIED: Added icons to tabs for better visual separation ---
        if fa:
            self.tab_widget.addTab(view_tab, fa.icon('fa5s.list-ul', color='#444'), "All Requisitions")
            self.tab_widget.addTab(self.view_details_tab, fa.icon('fa5s.eye', color='#444'), "View Requisition Details")
            self.tab_widget.addTab(self.entry_tab, fa.icon('fa5s.edit', color='#444'), "Requisition Entry")
            self.tab_widget.addTab(self.deleted_tab, fa.icon('fa5s.trash-alt', color='#444'), "Deleted Records")
        else:
    ...
    def _setup_view_tab(self, tab):
        ...
        # --- MODIFIED: Added icons to action buttons ---
        if fa:
            self.refresh_btn.setIcon(fa.icon('fa5s.sync-alt', color='white'))
            self.update_btn.setIcon(fa.icon('fa5s.pencil-alt', color='white'))
        ...
        # --- MODIFIED: Added icons to pagination buttons ---
        if fa:
    ...
    def _setup_deleted_tab(self, tab):
        ...
        # --- MODIFIED: Added icon to restore button ---
        if fa:
        ...
        # --- MODIFIED: Added icons to pagination buttons ---
        if fa:
            self.deleted_prev_btn.setIcon(fa.icon('fa5s.chevron-left'))
            self.deleted_next_btn.setIcon(fa.icon('fa5s.chevron-right'))
