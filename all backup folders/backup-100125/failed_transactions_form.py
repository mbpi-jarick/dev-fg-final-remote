...
class FailedTransactionsFormPage(QWidget):
    ...
    def init_ui(self):
        ...
        icon_label = QLabel()
        icon_label.setPixmap(qta.icon('fa5s.exclamation-triangle', color='#E53935').pixmap(32, 32))  # Red
        header_layout.addWidget(icon_label)

        # Header FG Failed Transaction
        title_label = QLabel("FG Failed Transaction")
        title_label.setStyleSheet("font-size: 20pt; font-weight: bold; color: #E53935;")
