...
# --- FAILED INVENTORY DASHBOARD WIDGET ---
class FailedDashboardWidget(QWidget):
    ...
    def _get_dashboard_styles(self) -> str:
        return f"""
            ...
            QLabel#ValueLabel {{ font-size: 16pt; font-weight: bold; color: {DANGER_ACCENT_COLOR}; }}
    ...
    def _create_lot_statistics_group(self) -> QGroupBox:
        ...
        # Apply internal style consistent with the theme (using red accent)
    ...
    def _export_to_excel(self):
        ...
        if filepath:
            try:
                ...
                export_df.to_excel(filepath, index=False, engine='openypxl')
...
if __name__ == '__main__':
    ...
    # Set the window title to match the new header
