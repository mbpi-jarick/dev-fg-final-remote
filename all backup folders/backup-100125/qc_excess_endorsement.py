# modify this code add header "QC Excess" --- ui only # qc_excess_endorsement.py
...
# REMOVED - Modern UI styling with qtawesome colored icons on tabs, buttons, and context menus.
...
class QCExcessEndorsementPage(QWidget):
    ...
    def init_ui(self):
        ...
        header_label = QLabel("QC Excess")
        header_label.setStyleSheet("font-size: 18pt; font-weight: bold; padding: 10px 0; color: #333333; background-color: transparent;")
    ...
    def _show_records_table_context_menu(self, position):
        ...
        menu = QMenu()
        # Simplified context menu actions (removed icons)
