...
class FGEndorsementPage(QWidget):
    ...
    def init_ui(self):
        ...
        # Removed all icons from tab titles
        self.tab_widget.addTab(view_tab, "All Records")
        self.tab_widget.addTab(self.entry_tab, "Entry Form")
        ...
        # Apply global stylesheet for required table appearance (dark blue selection)
        self.setStyleSheet("""
            QTableWidget::item:selected {
                background-color: #2596be; /* Dark blue selection color */
                color: white;
            }
    ...
    def _setup_deleted_tab(self, tab):
        ...
        # Focus policy set to NoFocus to remove the focus rectangle ("square")
