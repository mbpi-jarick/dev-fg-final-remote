...
class RRFPage(QWidget):
    ...
    def _delete_selected_breakdown(self):
        ...
        try:
            ...
            QMessageBox.information(self, "Success", "The selected lot breakdown and its transaction logs have been deleted.")
            self._load_all_breakdown_records()
        except Exception as e:
    ...
    def _save_lot_breakdown(self):
        ...
        try:
            ...
            QMessageBox.information(self, "Success",
                                    f"Lot breakdown for RRF {rrf_no}, Item {item_id} saved and logged as 'Quantity Out' in transactions.")
