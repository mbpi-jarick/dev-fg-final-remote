    ...
    def _show_selected_record_in_view_tab(self):
        ...
        try:
            with self.engine.connect() as conn:
                ...
                # --- FIX START: Removed description_1 and description_2 from the SELECT statement ---
                items = conn.execute(text(
                    """SELECT id, quantity, unit, product_code, product_color, no_of_packing, weight_per_pack, 
                       lot_no_1, lot_no_2, lot_no_3, attachments, unit_price
    ...
    def _save_record(self):
        ...
        try:
            with self.engine.connect() as conn, conn.begin():
                ...
                if items_data:
                    # --- FIX START: Removed description_1 and description_2 from INSERT statement ---
                    conn.execute(text("""
