...
from stock_balance import StockBalancePage  # <-- CORRECTLY IMPORTED
...
class ModernMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.inventory_report_page = InventoryReportPage(engine)
        self.stock_balance_page = StockBalancePage(engine)
        ...
        pages = [
            ...
            self.inventory_report_page,  # 1
            self.stock_balance_page,  # 2
    ...
    def create_side_menu(self):
        ...
        self.btn_inventory_report = self.create_menu_button("  Inventory Report", 'fa5s.chart-bar', 1)
        self.btn_stock_balance = self.create_menu_button("  Stock Balance", 'fa5s.balance-scale', 2)
        ...
        layout.addWidget(self.btn_inventory_report)
        layout.addWidget(self.btn_stock_balance)
    ...
    # ... (All sync methods, loading dialog, and other helper methods remain unchanged) ...
    ...
    def show_page(self, index):
        ...
        if current_widget == self.inventory_report_page:
            if hasattr(current_widget, '_generate_report'):
                current_widget._generate_report()
        elif current_widget == self.stock_balance_page:
            if hasattr(current_widget, '_load_product_codes'):
                current_widget._load_product_codes()
