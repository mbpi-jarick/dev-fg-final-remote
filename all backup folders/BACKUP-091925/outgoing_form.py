# outgoing_form.py
# FIX - Corrected inspector method call for inventory validation.
...
class AddItemDialog(QDialog):
    def __init__(self, parent=None, db_engine=None, data=None):
        ...
        layout.addRow("Lot# Used:", lot_layout)
    ...
    def _get_lot_beginning_qty(self, conn, lot_number):
        ...
        # --- FIX: Use the correct inspector method: get_table_names() ---
        ...
        for tbl in all_tables:
            ...
            if lot_col and qty_col:
                ...
                if result:
                    total_qty += Decimal(result)  # Ensure it's a Decimal
        return total_qty
    ...
    def _check_lot_in_inventory(self):
        lot_number = self.lot_used.text().strip()
        if not lot_number:
        ...
        try:
            ...
            if current_stock > 0:
                ...
                self.qty_req.setText(f"{current_stock:.2f}")
            else:
